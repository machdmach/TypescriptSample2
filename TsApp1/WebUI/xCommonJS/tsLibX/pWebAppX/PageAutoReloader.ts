...
//<script src='http://localhost:3131/cs/WebUIx/xCommonJS/tsLibX/pWebAppX/PageAutoReloader.js?v={Environment.TickCount}' type='module'></script>

class PageAutoReloader { //#WsClient, #websocket
    static async setup() {
        console.log("PageAutoReloader setup.......");
