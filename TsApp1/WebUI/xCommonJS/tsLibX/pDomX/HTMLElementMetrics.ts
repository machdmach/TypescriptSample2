...
export class HTMLElementMetrics {
    ...
    static getInfo(e: HTMLElement): string {
        if (!e) {
    ...
    static addProp(buf: StringBuilder, propName: string, propVal: string | number, desc: string) {
        buf.append("<tr>");
    ...
    //=========================================================================
    static hasVerticalScroll(node: HTMLElement) {
