import './tsLibX/ambientJS/globals.js';
import './tsLibX/pDomX/ConfigX.js';
import './tsLibX/pDomX/ConfigX.js'; //calling twice OK, no effect

import { ConfigX } from './tsLibX/pDomX/ConfigX.js';
import { CreateEl } from './tsLibX/pDomX/CreateEl.js';
...
if (ConfigX.isLocalDev) {
    ...
    else { //"add aspnet AutoReloading"
        let el = CreateEl.script_p(document.head, "http://localhost:4141/NetApps/cs/WebUIx/xCommonJS/tsLibX/pWebAppX/PageAutoReloader.js");
        el.type = "module";
    }
}
