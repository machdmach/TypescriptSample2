...
export class CircularQueue<E> {
    ...
    //=========================================================================
    static getArrayPreviousIndex(currIndex: number, arr: any[]) {
    ...
    //=========================================================================
    static getArrayNextIndex(currIndex: number, arr: any[]) {
    ...
    //=========================================================================
    static slice_tests() {
        let q = new CircularQueue<string>();
    ...
    static test1() {
        ...
        let q = new CircularQueue<String>(4);
        q.enqueue("aa");
        q.enqueue("bb");
        q.enqueue("cc c");
        q.enqueue("4 d");
