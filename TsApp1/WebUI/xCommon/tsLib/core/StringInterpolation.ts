...
export class StringInterpolation {
    ...
    interStrings!: string[]; // ! is the definiteAssignmentAssertion vs interStrings?: string[]; // allowing undefined.
    placeHolderExpressions!: string[];
    constructor(templateLiteral: string) {
    ...
    //=========================================================================
    setTemplateLiteral(templateLiteral: string) {
        this.interStrings = [];
    ...
    //=========================================================================
    private getValue(model: any, ph: string) {
        ...
        let varPath = ph;
        let formatOption: string | null = null;
        if (ph.includes(":")) {
            let pair = ph.split(":");
            varPath = pair[0];
        ...
        let valFormatted: string; // = valueObj[ph];
