...
export class RegExpr {
    ...
    static test1() {
        ...
        */
        ...
        let f1 = (ss: string) => ss.replace(new RegExp('\\.js\\.js', 'g'), ".js"); //gi insensitive
    ...
    //=========================================================================
    static camelCaseToEnglishTitle(s?: string) {
        if (!s) {
            return "";
        }
    ...
    static match_tests() {
        ...
        const re = /(\w+)\.mp3/g;
        let arr: RegExpMatchArray | null = s.match(re);
        if (arr) {
            for (let i = 0; i < arr.length; i++) {
                let r = arr[i];
            }
    ...
    //=========================================================================
    static RegExpExecArray_toStr(execResult: RegExpExecArray | RegExpMatchArray, consoleLog = true) {
    ...
    //=========================================================================
    static toStr(re: RegExp, consoleLog = true) {
        const buf = new StringBuilder();
        let fmt = "{0}={1}\n";
    ...
    //=========================================================================
    styleHyphenFormat(propertyName: string) {
