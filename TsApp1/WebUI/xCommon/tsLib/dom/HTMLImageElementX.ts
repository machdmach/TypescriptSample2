...
export class HTMLImageElementX {
    ...
    static setPositionAbsoluteCenter(selector: string): HTMLImageElement {
        let img = qs(selector) as HTMLImageElement;
    ...
    static async loadImages_eg() {
        let imgLoadPromises = new Array<Promise<any>>();
    ...
    //=========================================================================
    static async loadImageAsync(imgEl: HTMLImageElement, src: string) {
        let promise = new Promise((resolve, reject) => {
            imgEl.src = src;
            imgEl.addEventListener("load", (ev: Event) => {
                if (imgEl.complete) {
            ...
            imgEl.addEventListener("error", (ev: Event) => {
