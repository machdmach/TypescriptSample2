...
export class HTMLSelectElementX {
    ...
    //=========================================================================
    static addRecordStatusOptions(selectEltOrSelector, data) {
        if (!data) {
            throw Error("data is null or undefined");
        }
        let sel = qs(selectEltOrSelector);
    ...
    //=========================================================================
    static addCalendarQuarterOptions(selectEltOrSelector, startYear, startQuarter, numberOfQuarters) {
        let sel = qs(selectEltOrSelector);
        if (!(sel instanceof HTMLSelectElement)) {
            throw Error(getSelectorShortInfo(selectEltOrSelector) + " is not an HTMLSelectElement");
        }
