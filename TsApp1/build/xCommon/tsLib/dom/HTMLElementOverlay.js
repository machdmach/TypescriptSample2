...
export class HTMLElementOverlay {
    ...
    constructor(containerElt) {
        this.showStartTime = uninit;
        containerElt = document.body;
        this.containerElt = containerElt;
        const add_child = function (tagName, className, parentElt) {
        ...
        if (true) {
            ...
            s.fontSize = '1.0em';
            s.fontWeight = 'bold';
            s.backgroundColor = "#edd";
            s.border = "red 2px solid";
            s.maxWidth = "500px";
            s.margin = "auto";
        }
        if (true) {
