...
export class Polyfills {
    static checkPrerequisites() {
        ...
        if (False)
            AssertX.functionExists("entries", fd, errMesg);
    }
    //=========================================================================
    static registerDialogIfNeeded(dialogEl) {
    ...
    //=======================================================================
    static async loadResource(srcUrl) {
        let ext = PathX.getFileExtention(srcUrl);
        if (!ext) {
            throw Error("ext");
        }
        ext = ext === null || ext === void 0 ? void 0 : ext.toLowerCase();
        switch (ext) {
    ...
    //=======================================================================
    static async loadScript(srcUrl) {
