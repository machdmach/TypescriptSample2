...
*/
export class ToggleDisplay2Groups {
    /*
    clicking on button1 will display, button2 will hide.
    */
    constructor(containerEltOrSelector, positiveSelector, negativeSelector) {
        //=========================================================================
        this.positiveSwitches = [];
        this.negativeSwitches = [];
...
export class ToggleDisplayOnClick extends ToggleDisplay2Groups {
    ...
    */
    ...
    static newInstanceEmpty(containerEltOrSelector) {
