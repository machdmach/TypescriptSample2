...
export class CssExternalStyleSheet {
    //=========================================================================
    static findLinkedExternalCss(url) {
    ...
    //=========================================================================
    static removeExternalStyleSheet(url) {
    ...
    // }
    //=========================================================================
    static isExternalStyleSheetLinked(url) {
        let css = this.findLinkedExternalCss(url);
        return css !== null;
    }
    //=========================================================================
    static async loadExternalStyleSheet(srcUrl) {
