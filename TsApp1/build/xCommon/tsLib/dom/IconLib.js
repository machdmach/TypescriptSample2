...
export class IconLib {
    ...
    */
    static questionAnswer(text) { return this.buildIcon("fas fa-question-circle", text); }
    static info(text) { return this.buildIcon("fas fa-info-circle", text); }
    static error(text) { return this.buildIcon("fas fa-exclamation-circle", text); }
    static warn(text) { return this.buildIcon("fas fa-exclamation-triangle", text); }
    static ban(text) { return this.buildIcon("fas fa-ban", text); }
    static check(text) { return this.buildIcon("fas fa-check", text); }
    static info_letterI_z(text) {
    ...
    static plus(text) { return this.buildIcon("fas fa-plus", text); }
    static edit(text) { return this.buildIcon("fas fa-edit", text); } //<i class='fas fa-edit fa-lg' title='Edit'></i>
    static arrowBackiOS(text) {
        //large &lt; icon
        return this.buildIcon("arrow_back_ios", text);
    }
    static arrowLeft(text) {
        //triangle
        //https://material.io/resources/icons/?search=arr&icon=arrow_left&style=baseline
        return this.buildIcon("arrow_left", text);
    }
    static arrowRight(text) {
    ...
    //=========================================================================
    static buildIcon(iconClassName, text) {
