...
export class AppPage {
    static refreshBrowserOnServerRequest(apiClient) {
        ...
        if (ConfigX.apiVersion === uninitString) {
            ...
            if (Config.isLocalDebug)
                console.log("Not Refreshing browser b/c not change");
        }
    }
    //=========================================================================
    static fixHyperLinks(containerEltOrSelector) {
    ...
    //=========================================================================
    static prependToPageContent(eltOrStr) {
        let contentDiv = qs(".contentDiv");
        let el;
    ...
    //=========================================================================
    static setupIframeToggleButton(topWindowHref) {
    ...
    //=========================================================================
    static SetDocumentTitle(docTitle) {
        let env;
        if (ConfigX.isDbDev) {
            env = "Dev-";
        }
