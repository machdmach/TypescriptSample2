...
export class HFormFunctionalityActivate {
    constructor(form) {
        this.form = form;
    }
    ...
    addFunctionality_Inactivate(inactivateLabel = "Inactivate") {
        ...
        let btn = form.buttonPane.addButtonDanger(btnInnerHtml, (ev) => {
    ...
    //=========================================================================
    async btnInactivate_clicked(ev, inactivateLabel) {
        let form = this.form;
    ...
    //=========================================================================
    async btnReactivate_clicked(ev, reactivateLabel) {
        let form = this.form;
