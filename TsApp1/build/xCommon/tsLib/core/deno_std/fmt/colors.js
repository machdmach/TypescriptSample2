...
const noColor = (_b = (_a = globalThis.Deno) === null || _a === void 0 ? void 0 : _a.noColor) !== null && _b !== void 0 ? _b : true;
let enabled = !noColor;
...
function run(str, codeP) {
    return enabled
        ? `${codeP.open}${str.replace(codeP.regexp, codeP.open)}${codeP.close}`
        : str;
}
