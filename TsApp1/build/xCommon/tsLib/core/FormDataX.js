...
export class FormDataX {
    static buildURLSearchPart(fd, includePrefixQuestionMark = true) {
        function encode(t) {
    ...
    //=========================================================================
    static fromObject2(obj, fd, namespace = '') {
        //let formData = form || new FormData();
        for (let propertyName in obj) {
            if (!obj.hasOwnProperty(propertyName) || obj[propertyName] === undefined)
                continue;
    ...
    //=========================================================================
    static fromObject3(obj1, rootName, ignoreList) {
        const formData = new FormData();
        function appendFormData(obj, root = '') {
            if (!ignore(root)) {
                root = root || '';
