...
export class ObjectX {
    ...
    //=========================================================================
    static showOwnProperties(obj, objTitle) {
        if (obj === null || obj === undefined) {
    ...
    //=========================================================================
    static deleteAllProperties(obj) {
    ...
    //=========================================================================
    static getNonEmptyProperties(obj) {
        let rval = {};
        for (let propName in obj) {
            if (!obj.hasOwnProperty(propName)) {
                //delete obj[propName];
    ...
    //=========================================================================
    static getValue(obj, path, defaultVal = undefined) {
    ...
    */
    static completeAssign(target, ...sources) {
        sources.forEach(source => {
            let descriptors = Object.keys(source).reduce((accum, key) => {
