...
export class UrlX {
    static remove_zzThings(urlHref) {
    ...
    static removeQueryParam(urlHref, paramName) {
        let url = new URL(urlHref);
        let searchParams = url.searchParams;
    ...
    static setQueryNV(urlHref, paramName, value) {
        if (!paramName) {
    ...
    //=========================================================================
    static encodeURIComponentForPath(url) {
